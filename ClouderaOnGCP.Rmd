...
To see what flag values you need to use, use this trick: on the instances list screen, click on down-arrow next to "SSH".

<img src="./assets/ssh_flags1.png">

Choose "View gcloud command". (This is not your SSH command. Here, you just consult with your flags' values.)
...
<img src="./assets/hue1.png" style="width:50%; border:1px solid; margin-right: 20px" align="left">

Username and password: cloudera/cloudera

<img src="./assets/hue2.png" style="width:50%; border:1px solid; margin-right: 20px" align="left">
