...
As long as you don't destroy your VM instance (it can be stopped and started as needed), the docker container is running inside the VM instance. From now on (after staring your VM instance), type only one command for remote ssh login:
