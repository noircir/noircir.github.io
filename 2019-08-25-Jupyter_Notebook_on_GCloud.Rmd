...
#### 2. Connect to your VM instance with SSH. Now you are inside your new computer.

#### 3. Install Anaconda.

#### 4. Start Jupyter Notebook.

#### 5. Create an SSH tunnel between your cloud computer and local computer.

#### 6. View Jupyter Notebook in your local browser.

#### 7. Upload and download files to and from the cloud computer.
