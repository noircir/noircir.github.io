...
Clusters are usually used for compute-intensive deep learning algorithms and Big Data. When creating a cluster, CGP automatically installs Hadoop, Spark, Hive, and Pig (their version updates TBD). 
...
2. ATTENTION: Choose a correct cluster version: the one with Python3 is  __[Cluster version 1.4](https://cloud.google.com/dataproc/docs/tutorials/python-configuration#image_version_14)__

3. Choose whether you need Anaconda or Miniconda: 
  (__[a link](http://deeplearning.lipingyang.org/2018/12/23/anaconda-vs-miniconda-vs-virtualenv/)__ to help decide on whether you need Anaconda or Miniconda) 
