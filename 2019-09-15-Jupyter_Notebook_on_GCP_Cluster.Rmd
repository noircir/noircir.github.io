...
However, the same cluster (since it is a virtual machine) can run other applications, like Jupyter Notebook, RStudio, and Docker images. In fact, GCP itself has instructions for installing Jupyter Notebook and RStudio on a cluster: (links here)


### Part 1. Create a cluster and run Jupyter Notebook. 

0. Create a bucket (where you can save Jupyter notebooks and RStudio files). This bucket will exist as long as you have your GCP account.
