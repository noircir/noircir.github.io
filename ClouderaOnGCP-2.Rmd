...
## Running Cloudera Quickstart Image on Google Cloud instance - Part 2 : Connecting to Hue web interface
...
### (Optional) How to check port mapping of running container
